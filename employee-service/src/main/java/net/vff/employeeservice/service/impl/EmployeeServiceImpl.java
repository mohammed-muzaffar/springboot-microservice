package net.vff.employeeservice.service.impl;

import io.github.resilience4j.retry.annotation.Retry;
import lombok.AllArgsConstructor;
import net.vff.employeeservice.dto.APIResponseDto;
import net.vff.employeeservice.dto.DepartmentDto;
import net.vff.employeeservice.dto.EmployeeDto;
import net.vff.employeeservice.dto.OrganizationDto;
import net.vff.employeeservice.entity.Employee;
import net.vff.employeeservice.mapper.EmployeeMapper;
import net.vff.employeeservice.repository.EmployeeRepository;
import net.vff.employeeservice.service.APIClient;
